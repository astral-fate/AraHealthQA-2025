...
# Your Groq API key will be accessed securely.
try:
    ...
    print("Please enter your Groq API key manually.")
...
OUTPUT_CSV = '/content/drive/MyDrive/AraHealthQA/t2t1/final_result/predictions_fitb_choices_CoT.csv'
...
def generate_answer(question):
    """
    Sends an MCQ question to the Groq API, prompting the model to use
    Chain of Thought and return a final answer in a structured format.
    The function then parses this final answer.
    """
    messages = [

...
OUTPUT_CSV = '/content/drive/MyDrive/AraHealthQA/t2t1/data/predictions_bias_test_OpenBioLLM_8B_local.csv'
...
def main():
    ...
    if os.path.exists(OUTPUT_CSV):
        ...
        # Also include empty strings (NaNs from CSV) in the rerun list

...
OUTPUT_CSV = '/content/drive/MyDrive/AraHealthQA/t2t1/data/predictions_bias_test_deepseek.csv'
...
def generate_answer(question, client):
    ...
    try:
        ...
        # MODIFIED: Updated model, temperature, and max_tokens as requested

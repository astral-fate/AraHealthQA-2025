...
# --- File paths and column names (Set for your data) ---
INPUT_CSV = '/content/drive/MyDrive/AraHealthQA/t2t1/data/multiple-choice-withbias.csv'
OUTPUT_CSV = '/content/drive/MyDrive/AraHealthQA/t2t1/data/predictions_bias_test_lamma.csv'
...
def generate_answer(question, client):
    ...
    try:
        # The API call using the Groq client
        completion = client.chat.completions.create(
            ...
            max_tokens=2048, # Renamed from max_completion_tokens
            top_p=1,
            stream=True,
            stop=None,
        )
...
def main():
    ...
    # It's recommended to set the GROQ_API_KEY as an environment variable.
    ...
    try:
        ...
        print(f"❌ Failed to initialize the Groq client. Error: {e}")
        return

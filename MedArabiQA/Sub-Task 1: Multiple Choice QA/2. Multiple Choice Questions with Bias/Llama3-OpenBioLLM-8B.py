...
# Import the InferenceClient for Hugging Face API
...
OUTPUT_CSV = '/content/drive/MyDrive/AraHealthQA/t2t1/data/predictions_bias_test_OpenBioLLM_8B_API.csv'
...
--- Example ---
Question:
املأ الفراغات في الجملة التالية:
...
# --- Function to Generate Answers using Hugging Face Inference API ---
def generate_answer(question, client):
    """
    Generates an answer using the Hugging Face InferenceClient.
    """
    # Construct a single, clear prompt for the text generation model
    ...
    try:
        # Use the client.text_generation method
...
def main():
    ...
    # --- Initialize Hugging Face InferenceClient using Colab Secrets ---
    try:
        # Make sure you have set the 'HF_TOKEN' secret in your Colab notebook
        ...
        print(f"❌ Failed to initialize the Hugging Face client. Error: {e}")
        print("Please ensure you have set the 'HF_TOKEN' in your Google Colab secrets.")
        return

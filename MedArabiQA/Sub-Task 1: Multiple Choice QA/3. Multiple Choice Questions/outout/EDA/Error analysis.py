...
mcq_model_data = [
    {
        'model_name': 'Qwen',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/qwen_mcq.csv',

        'time_minutes': 2347.01 / 60
    },
    {
        'model_name': 'DeepSeek',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/predictions_mcq_deepseek.csv',

        'time_minutes': 24.0
    },
    {
        'model_name': 'Llama3 70B',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/predictions_mcq_llama3.3-70b.csv',

        'time_minutes': 18.0
    },
    {
        'model_name': 'Colosseum',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/predictions_mcq_colosseum.csv',

        'time_minutes': 24.0
    },
    {
        'model_name': 'Palmyra-Med',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/predictions_palmyra.csv',

        'time_minutes': 506.71 / 60
    },
    {
        'model_name': 'Mixtral',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/mixtral.csv',

        'time_minutes': 95.40 / 60
    },
    {
        'model_name': 'OpenBioLLM',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/predictions_OpenBioLLM_8B_mcq.csv',

        'time_minutes': 11 + 46/60
    },
    {
        'model_name': 'BiMediX2',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/BiMediX2_predictions_mcq.csv',

        'time_minutes': 4.0
    },
    {
        'model_name': 'Biomistral',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/predictions_biomistral_mcq.csv',

        'time_minutes': 32 + 38/60
    },
    {
        'model_name': 'MedGemma',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/predictions_medgemma_quantized_mcq.csv',

        'time_minutes': 165
    },
    {
        'model_name': 'Gemini',
        'csv_path': '/content/drive/MyDrive/AraHealthQA/mcq/gemini 2 pro.csv',

        'time_minutes': 6.0
    }
]

models_df_initial = pd.DataFrame(mcq_model_data)

# Load original ground truth data
try:
    original_data_path = '/content/drive/MyDrive/AraHealthQA/multiple-choice-questions.csv'
...
if all_errors:
    ...
    if not pivot_df.empty:
        error_pivot_table = pivot_df.pivot_table(index='Category', columns='model_name', values='Question', aggfunc='count', fill_value=0)
...
if all_errors:
    ...
    plt.title('Error Distribution: Top 5 Models vs. Top 5 Categories (MCQ Task)', fontsize=16, weight='bold', pad=20)
    ...
    ax1.set_title('Model Errors per Medical Category (MCQ Task)', fontsize=18, weight='bold')
    ...
    ax2.set_title('Quadrant Analysis: Model Accuracy vs. Execution Time (MCQ Task)', fontsize=16, weight='bold', pad=20)

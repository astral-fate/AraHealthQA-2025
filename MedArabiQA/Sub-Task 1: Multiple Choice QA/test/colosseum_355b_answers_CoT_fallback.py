...
3.  **State the Final Answer**: After your analysis, you must conclude your response with the exact phrase 'The final answer is: [letter]', where [letter] is the single Arabic letter of the correct option."""},
    ...
    try:
        completion_1 = client.chat.completions.create(
            model=MODEL_NAME, messages=messages_attempt1, temperature=0.1, top_p=0.7, max_tokens=1024, stream=True
        )
...
def run_prediction_pipeline():
    ...
    OUTPUT_CSV = "/content/drive/MyDrive/AraHealthQA/t2t1/colosseum_355b_answers_CoT_fallback.csv" # New file for this version

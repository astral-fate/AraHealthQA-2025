...
# --- Function to Generate Answers (MODIFIED) ---
def generate_answer(question, pipe):
    ...
    # --- CHANGE IS HERE ---
    # Add a forceful reminder at the end of the user's question to ensure the model complies.
...
def evaluate_mcq_accuracy(predictions, ground_truths):
    ...
    valid_indices = [i for i, p in enumerate(predictions) if p not in ["INFERENCE_ERROR", ""]]
    ...
    print(f"Inference/Parsing Errors: {failed_or_empty}")
...
def main():
    ...
    if os.path.exists(OUTPUT_CSV):
        ...
        # --- Model Loading ---
        print("="*50)
        print("🚀 Initializing local model: google/medgemma-27b-text-it with 4-bit Quantization")
        print("This may take several minutes and requires a GPU with sufficient memory.")
        print("="*50)
        ...
        print(f"Starting prediction generation process with MedGemma...")
        predictions = []

...
OUTPUT_CSV = '/content/drive/MyDrive/AraHealthQA/t2t1/final_result/predictions_fitb_choices_Palmyra-Med_with_Fallback.csv'
...
# --- Primary Function to Generate Answers ---
def generate_answer_primary(question):
    """
    Sends an MCQ question to the NVIDIA API, prompting the Palmyra-Med model to use
...
# --- Function to Evaluate MCQ Accuracy (MODIFIED with Normalization) ---
def evaluate_mcq_accuracy(predictions, ground_truths):
    ...
    # Use the normalized lists for accuracy calculation
...
def main():
    ...
    if os.path.exists(OUTPUT_CSV):
        ...
        print(f"'{OUTPUT_CSV}' not found. Starting prediction process with Palmyra-Med and Llama 3 Fallback...")
        predictions = []
        ...
        for index, row in df.iterrows():
            ...
            print(f"Processing question {index + 1}/{total_questions} with Palmyra-Med (Primary)...")
